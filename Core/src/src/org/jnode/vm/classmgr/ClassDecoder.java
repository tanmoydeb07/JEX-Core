...
import org.jnode.vmmagic.pragma.PragmaException;
import org.jnode.vmmagic.pragma.UninterruptiblePragma;
...
public final class ClassDecoder {
    ...
    private static final MethodPragmaException[] METHOD_PRAGMA_EXCEPTIONS = new MethodPragmaException[]{
        ...
        new MethodPragmaException(org.jnode.vmmagic.pragma.InlinePragma.class,
            MethodPragmaFlags.INLINE),
        new MethodPragmaException(org.jnode.vmmagic.pragma.NoInlinePragma.class,
            MethodPragmaFlags.NOINLINE)};

    private static final PragmaInterface[] INTERFACE_PRAGMAS = new PragmaInterface[]{new PragmaInterface(
        org.jnode.vmmagic.pragma.Uninterruptible.class,
